...
from users.permissions import IsAccountOwnerOrAdm, IsAdminOrSeller
...
class OrderView(ListCreateAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        products_cart = ProductCart.objects.filter(cart_id=cart_id).select_related('product')
        ...
        for seller_id, seller_data in products_by_seller.items():
            ...
            order = Order.objects.create(seller_id=seller_id, user=user, status=StatusChoices.PEDIDO_REALIZADO)
